...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../View/css/PaiementStyle.css">
...
<!--   -->
   ...
   <article class="position-absolute top-50 start-50 translate-middle">
      ...
      <div class="flip-card mcard1 mcard4">
        <div class="flip-card-inner">
            <div class="flip-card-front">
                <p class="heading text-light">MASTERCARD</p>
                ...
                <p class="number text-light">9759 2484 5269 6576</p>
                <p class="valid_thru text-light">VALID THRU</p>
                <p class="date text-light">1 2 / 2 4</p>
                <p class="name text-light">BRUCE WAYNE</p>
            </div>
...
<div class="d-flex justify-content-center mcard2 mcard3">
    <div class="cards ">
      <div class="card one">
        <div class="cardDetails">
          <div class="cardDetailsHaeder me-5">Paypal</div>
          <a class="btn1 mbtn">
      ...
      <div class="card two">
        <div class="cardDetails">
          <div class="cardDetailsHaeder me-5">Lydia</div>
          <a class="btn1 mbtn">
      ...
      <div class="card three">
        <div class="cardDetails">
          <div class="cardDetailsHaeder me-5">Crypto</div>
          <a class="btn1 mbtn">
