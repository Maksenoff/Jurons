...
<head>
    ...
    <link rel="stylesheet" href="../cam/StatistiqueStyle.css">
        ...
        <nav class="navbar fixed-bottom navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link ms-5" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                                ...
                                </svg> Instagram</a><a class="nav-link ms-5" href="#"><svg
                    ...
                    <div class="collapse navbar-collapse d-flex justify-content-around" id="navbarNav">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link me-5" href="#">Faire un Don</a>
                            </li>
                            <li class="nav-item">
