...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../View/css/NavStyle.css">
    <link type="text/css" rel="stylesheet" href="../View/css/HomeStyle.css">
...
<div class="d-flex justify-content-evenly align-items-center ptop">
          <div class="card">
            <div class="content">
              <div class="back">
              ...
              <div class="front">
                ...
                <div class="front-content">
                  <div class="description">
                    <div class="title mgtop">
                      <p class="title">
                        <a href="../controller/executeInfraction.php" class="none text-light">INFRACTIONS</a>
                      </p>
                    </div>                   
                  </div>
                </div>
              ...
              <div class="front">
                ...
                <div class="front-content">
                  <div class="description">
                    <div class="title mgtop">
                      <p class="title">
                        <a href="../view/Statistique.php" class="none text-light">STATISTIQUES</a>
                      </p>
                    </div>                   
                  </div>
                </div>
              ...
              <div class="front">
                ...
                <div class="front-content">
                  <div class="description">
                    <div class="title mgtop">
                      <p class="title">
                        <a href="../controller/executeHistorique.php" class="none text-light" >HISTORIQUE</a>
                      </p>
                    </div>                   
                  </div>
                </div>
