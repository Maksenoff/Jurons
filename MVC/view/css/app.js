...
class PieChart extends HTMLElement {
    constructor() {
        ...
        const colors = this.getAttribute('colors')?.split(';') ?? ['#6C8483','#2a9d8f', '#347371', '#519D7A', '#939694', '#217D64', '#5D605D', '#4F8C8A', '#266F56' ,'#154F3B'];
...
label.style.setProperty('top',`${(point.y * 0.80 * 0.50 + 0.50) * 100}%`)
label.style.setProperty('left',`${(point.x * 0.80 * 0.50 + 0.50) * 100}%`)
}
}
