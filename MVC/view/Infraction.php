...
<body>
  ...
  <table class="radioGaga">
    ...
    <tr>
      ...
      <th id="pj"> <input type="radio" id="pj" value="pj" name="inf">
        <label for="">Petit Juron</label>
      </th>

      <th> <input type="radio" id="gj" value="gj" name="inf">
        <label for="">Gros Juron</label>
      </th>

      <th> <input type="radio" id="ge" value="ge" name="inf">
        <label for="">Geste</label>
      </th>
      ...
      <th>
        ...
        <!-- <input type="submit" id="balance" value="Valider" name="balance"> -->
        <div id="holder">
