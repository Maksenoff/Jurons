...
<!-- ///////////////////////// Tableau //////////////////////////////////////////////-->
    ...
    <!-- ////////////////////// Tableau 1 /////////////////-->
<form action="" method="$_GET" name="validerInf">
<table class = "radioGaga">
  ...
  <div class="dropdown Infraction">
    ...
    <ul class="dropdown-menu dropdown-menu-dark">
      ...
      <li><a class="dropdown-item" href="#" value="pj">Petit Juron</a></li>
      <li><a class="dropdown-item" href="#" value="gj">Gros Juron</a></li>
      <li><a class="dropdown-item" href="#" value="ge">Geste</a></li>
      <li><a class="dropdown-item" href="#" value="ro">Rôt</li>
...
<div class="dropdown retard">
    <a class="btn btn-outline-light dropdown-toggle bg-dark-subtle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
      Retard
    </a>

    <ul class="dropdown-menu dropdown-menu-dark">

      <li><a class="dropdown-item" href="#" value=0>0</a></li>
      <li><a class="dropdown-item" href="#" value=10>10</a></li>
      <li><a class="dropdown-item" href="#" value=20>20</a></li>
      <li><a class="dropdown-item" href="#" value=30>30</a></li>
      <li><a class="dropdown-item" href="#" value=40>40</a></li>
      <li><a class="dropdown-item" href="#" value=50>50</a></li>
      <li><a class="dropdown-item" href="#" value=60>60</a></li>
